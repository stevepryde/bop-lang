...
If you're here to embed Bop in a host application, jump to [Embedding Bop](/docs/embedding/) and start there. The rest of this site is the language guide and reference.
...
- **Embedding Bop in a host** — [Embedding Bop](/docs/embedding/) walks through the `BopHost` trait, resource limits, module resolution, and picking an engine.
