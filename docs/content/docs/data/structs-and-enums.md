+++
title = "Structs & Enums"
description = "Bop supports user-defined **struct** and **enum** types, with methods attached via `fn Type.method(self, ...)`. They give you type names in error messages, structural pattern matching, and an identity-aware equality."
weight = 12
